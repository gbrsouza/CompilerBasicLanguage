...
variable::variable(token _tok, string* _name) : variable(_tok, _name, nullptr, nullptr) { }

variable::variable(token _tok, string* _name, expr* _idx) : variable(_tok, _name, _idx, nullptr) { }

variable::variable(token _tok, string* _name, expr* _idx1, expr* _idx2) : expr(_tok), name(_name), idx1(_idx1), idx2(_idx2) { }

template<class T>
ast::literal_expr<T>::literal_expr(token _tok, T _value) : expr(_tok), value(_value) { }
